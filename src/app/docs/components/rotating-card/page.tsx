...
export default function RotatingCardPage() {
  return (
    <div className="max-w-4xl mx-auto">
      <h1 className="text-3xl font-bold mb-4">Rotating Card</h1>
      <p className="text-gray-600 dark:text-gray-400 mb-8">
        A card that rotates on hover with spring physics.
      </p>
  ...
  return (
    ...
    >
      ...
      <div className="mb-8">
        ...
        <pre className="bg-gray-100 dark:bg-gray-800 p-4 rounded text-sm overflow-x-auto">
          <code>{`import { RotatingCard } from "@/components/ui/rotating-card"
        ...
        <table className="w-full border-collapse border border-gray-300 dark:border-gray-700">
          ...
          <tbody>
            <tr>
              ...
              <td className="border border-gray-300 dark:border-gray-700 p-2">The content inside the card</td>
            </tr>
            <tr>
